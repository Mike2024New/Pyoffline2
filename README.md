...
и пакеты (resourcs/packages_storage), то есть те ресурсы которые сохраняются и могут использоваться в том числе оффлайн.
...
[Смотреть анимацию](docs/assets/path_variables.gif)
...
[Смотреть анимацию](docs/assets/use_case.gif)
